...
namespace AcademIQ_backend.Migrations
{
    ...
    [Migration("20241026133427_InitialCreate")]
            ...
            modelBuilder.Entity("AcademIQ_backend.Models.CoursesAll.CoursesOnAir", b =>
                {
                    ...
                    b.HasKey("StudentId", "CourseId", "InstructorId", "StartDate");
            ...
            modelBuilder.Entity("AcademIQ_backend.Models.Users.Roles", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Role_Code"));
            ...
            modelBuilder.Entity("AcademIQ_backend.Models.Users.Students", b =>
                {
                    ...
                    b.HasOne("AcademIQ_backend.Models.CoursesAll.Courses", null)
                        .WithMany("Students")
