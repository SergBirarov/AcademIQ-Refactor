...
//            switch (response.Role_Code)
//            {
//                case 1:
//                    userData = await _context.Staff.FirstOrDefaultAsync(s => s.StaffId == response.UserId);
//                    break;
//                case 2:
//                    userData = await _context.Instructors.FirstOrDefaultAsync(i => i.InstructorId == response.UserId);
//                    break;
//                case 3:
//                    userData = await _context.Students.FirstOrDefaultAsync(st => st.Id == response.UserId);
//                    break;
//            }
